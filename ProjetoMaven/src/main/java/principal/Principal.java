...
import basica.HistoricoServico;
...
//		Endereco end = new Endereco("BNH", "Rua Sem Fim", "233");
	...
	/*	PessoaDao pessoa = new PessoaDao();
		...
		p = pessoa.somaVeiculoNome(1);
		
		System.out.println("Nome :"+ p.getNome() + "Email :"+p.getEmail()+"Quantidade : "+p.getQtdVeiculo() );
		
		System.out.println(pessoa.somaQtdCarros("Maria")); */
...
//		pessoa.listarPessoasVeiculos().forEach(System.out::println);
		...
		h.setFuncionario(f2);
		h.setVeiculo(v2);
		h.setNomeServico("Troca do amortecedor");
